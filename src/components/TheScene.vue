<template>
	...
	>
		<a-entity id="rig" position="25 10 0">
			<a-entity id="camera" camera look-controls="false" wasd-controls="false"></a-entity>
		</a-entity>
		<a-assets>
			...
			<img id="vue-img" src="../assets/img/vue.png" />
		</a-assets>
  ...
  mounted() {
    ...
    document.addEventListener('wheel', (e) => {
       ...
       */
        ...
        if (this.vueText.y > 11.4 || delta === 1) {
          this.vueText.y += (this.animationScrollSpeed * delta);
        }
        if (this.vueText.y < 15 || delta === 1) {
          this.angularText.y += (this.animationScrollSpeed * delta);
          this.angular.y += (this.animationScrollSpeed * delta);
        }
        if (this.vueImage.y > 9.5 || delta === 1) {
          this.vueImage.y += (this.animationScrollSpeed * delta);
        }
        ...
        if (vuePassed && this.vueImage.y <= 9.5) {
          this.scrollFase = 4;
        }
